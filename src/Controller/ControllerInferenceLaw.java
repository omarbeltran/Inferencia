...
public final class ControllerInferenceLaw {
    ...
    private void loadDefaultInferenceLaw() { 
        ...
        InferenceLaw inferenceLaw3 = new InferenceLaw(4, " P , Q : P v Q", "LA", "Ley de la Adjunción");
        ...
        InferenceLaw inferenceLaw4 = new InferenceLaw(5, "~R , P v Q :~R ^ ( P v Q )", "LC", "Ley de Conjunción");
        ...
        InferenceLaw inferenceLaw8 = new InferenceLaw(9, " P v P : P", "LDS", "Idempotencia");
        ...
        InferenceLaw inferenceLaw9 = new InferenceLaw(10, " P : P v Q", "LA", "Ley de la Adición");
        ...
        InferenceLaw inferenceLaw10 = new InferenceLaw(11, " P-> S , Q->~R , P v Q : S v~R", "DC", "Dilema Constructivo");
